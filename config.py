...
# Image Settings
# --------------
imageNamePrefix = 'front-'  # default= 'cam1-' for all image file names. Eg garage-
...
imageJpegQuality = 60      # default = 95  jpg Encoder Quality Values 1(low)-100(high min compression) 0=85 
...
showTextFontSize = 24      # default= 18 Size of image Font in pixel height
...
# -------------------------------------
nightTwilightThreshold = 80 # default= 90 dayPixAve where twilight starts (framerate_range shutter)
...
nightSleepSec = 4           # default= 30 Sec - Time period to allow camera to calculate low light AWB
...
motionTrackTrigLen = 40     # default= 75 px Length of motion track to Trigger motionFound
motionTrackMinArea = 80    # default= 200 sq px  Minimum Area required to start tracking
...
motionQuickTLOn = True      # default= False  True=Take a quick time lapse sequence rather than a single image (overrides motionVideoOn)
motionQuickTLTimer = 10     # default= 20 Duration in seconds of quick time lapse sequence after initial motion detected
...
motionNumMax  = 2000        # default= 0 Max number of motion images desired. 0=Continuous
